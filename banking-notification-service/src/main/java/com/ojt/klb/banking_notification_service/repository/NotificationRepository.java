...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    @Query(value = "select new com.ojt.klb.banking_notification_service.dto.NotificationDTO(n.customerId,n.content,nt.subjectTemplate,nt.templateName ,n.sendDate) " +
