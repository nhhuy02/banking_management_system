...
public class TransactionController {
  ...
  public ResponseEntity<ApiResponse<List<TransactionResponse>>> getTransactions(
    ...
    ApiResponse<List<TransactionResponse>> response = service.getTransaction(accountNumber);
  ...
  public ResponseEntity<ApiResponse<List<TransactionResponse>>> getTransactionByTransactionReference(
    ...
    ApiResponse<List<TransactionResponse>> response = service.getTransactionByTransactionReference(
        referenceNumber);
    return new ResponseEntity<>(response, HttpStatus.OK);
  }
  ...
  public ResponseEntity<?> findTransactions(@RequestParam String accountNumber,
    ...
    List<SearchDataDto> transactions = service.findTransactions(
  ...
  public ResponseEntity<ApiResponse> saveUtilityPaymentTransaction(
      @RequestBody TransactionDto transactionDto, @RequestParam String referenceNumber) {
    return new ResponseEntity<>(
        service.saveUtilityPaymentTransaction(transactionDto, referenceNumber), HttpStatus.CREATED);
  }
}
