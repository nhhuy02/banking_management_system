...
public class TransactionController {
    ...
    public ResponseEntity<ApiResponse<List<TransactionResponse>>> getTransactionByTransactionReference(@PathVariable String referenceNumber) {
        ApiResponse<List<TransactionResponse>> response = service.getTransactionByTransactionReference(referenceNumber);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
