...
public class TransactionServiceImpl implements TransactionService {
  ...
  @Override
  public ApiResponse<List<TransactionResponse>> getTransaction(String accountNumber) {
    List<TransactionResponse> transactions = repository.findByAccountNumber(accountNumber)
  ...
  @Override
  public ApiResponse<List<TransactionResponse>> getTransactionByTransactionReference(
      String transactionReference) {
    List<TransactionResponse> transactions = repository.findByReferenceNumber(transactionReference)
        .stream().map(transaction -> {
          TransactionResponse transactionResponse = new TransactionResponse();
          BeanUtils.copyProperties(transaction, transactionResponse);
          transactionResponse.setTransactionStatus(transaction.getStatus().toString());
  ...
  @Override
  public ApiResponse saveUtilityPaymentTransaction(TransactionDto transactionDto,
  ...
  @Override
  public SearchDataDto findLastTransactionByAccountNumberBeforeDate(
